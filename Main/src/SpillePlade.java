public abstract class SpillePlade {
    ...
    public SpillePlade() {
        ...
        Felt palaceGates = new Felt("Palace Gates",100,"Du er landet på Palace Gates og 100 kr. er tilføjet til din konto");
        Felt coldDesert = new Felt("Cold Desert",-20,"Du er landet på Cold desert og 20 kr. er trukket fra din konto");
        Felt walledCity = new Felt("Walled City",180,"Du er landet på Walled City og 180 kr. er tilføjet til din konto");
        Felt monastery = new Felt("Monastery",0,"Du er landet på monastery og ingen penge er tilføjet til din konto");
